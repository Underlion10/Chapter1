...
<%@page session="true" import="java.util.*,ebookshop.pojo.Book"%>
<html>
<head>
...
<%  // Scriptlet 2: copy the book list to the selection control
  ...
  %>
      ...
      Quantity: <input type="text" name="qty" size="3" value="<%String num = (request.getParameter("qty") != null && request.getAttribute("errorType") == null)
      ? request.getParameter("qty") : "1"; out.print(num); %>">
